...
> {note} Si deseas tener la extensión de PHP PhpRedis instalada por medio de PECL, deberás renombrar el alias `Redis` en tu archivo de configuración `config/app.php`.
