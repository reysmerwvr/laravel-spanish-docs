...
::: danger Nota 
Para usar esta característica, tu aplicación debe estar haciendo uso de los drivers de caché `memcached` o `redis` como el driver de caché por defecto de tu aplicación. Adicionalmente, todos los servidores deben estar comunicandose con el mismo servidor de caché central.
:::
